...
contract TokenFarm {
    ...
    function withdraw() external {
        ...
        require(isStaking[msg.sender], "No esta haciendo staking");
    ...
    function claimRewards() external {
        ...
        require(
            pendingAmount > 0,
            "No hay recompensas pendientes para reclamar"
        );
    ...
    function distributeRewards(address beneficiary) private {
        // Obtener el último checkpoint del usuario desde ckeckpoints.
        ...
        if (block.number > lastCheckpoint && totalStakingBalance > 0) {
            ...
            uint256 reward = (blocksPassed *
                REWARD_PER_BLOCK *
                stakingBalance[beneficiary]) / totalStakingBalance;
